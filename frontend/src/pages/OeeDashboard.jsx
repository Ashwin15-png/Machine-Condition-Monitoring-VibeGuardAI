          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <Card className="bg-slate-900 border-slate-800">
                ...
                <div className="text-3xl font-bold font-mono text-slate-100">{data.systemOee.overall}%</div>
                <p className="text-[10px] text-slate-400 mt-1">World Class Target: 85.0%</p>
              </Card>
              ...
              <Card className="bg-slate-900 border-slate-800">
                ...
                <p className="text-[10px] text-slate-400 mt-1">Target: 90.0% (Operating / Planned)</p>
              </Card>
              ...
              <Card className="bg-slate-900 border-slate-800">
                ...
                <p className="text-[10px] text-slate-400 mt-1">Target: 95.0% (Actual / Ideal Cycle)</p>
              </Card>
              ...
              <Card className="bg-slate-900 border-slate-800">
                ...
                <p className="text-[10px] text-slate-400 mt-1">Target: 99.9% (Good / Total Parts)</p>
              </Card>
            </div>
                  ...
                  <table className="w-full text-left text-xs border-collapse">
                    <thead>
                      <tr className="bg-slate-900/80 border-b border-slate-800 text-slate-400 uppercase tracking-wider font-semibold">
                        ...
                        <th className="py-3 px-4 font-bold text-slate-100">Overall OEE</th>
                        <th className="py-3 px-4 text-slate-500">Daily Trajectory</th>
                      </tr>
                    </thead>
